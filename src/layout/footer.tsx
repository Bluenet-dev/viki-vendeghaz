      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-5">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="mt-3 font-mono text-xs uppercase tracking-widest text-salt">
              Szilvásvárad
            </p>
            <p className="mt-4 text-sm text-mist/70 leading-relaxed">
              Sóbarlang, szauna és három szoba a Bükki Nemzeti Park szívében.
            </p>
        ...
        <div className="mt-12 border-t border-mist/10 pt-8 flex flex-col sm:flex-row justify-between gap-4">
          ...
          <p className="text-xs text-mist/40">
            3348 Szilvásvárad · +36 30 XXX XXXX
          </p>
        </div>
      </div>
    </footer>
