...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/szobak/komfort-ketagyas`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  { url: `${BASE_URL}/szobak/komfort-franciaagyas`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  { url: `${BASE_URL}/szobak/superior`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.9 },
  { url: `${BASE_URL}/vendeghaz/kert-udvar`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
  { url: `${BASE_URL}/vendeghaz/medence`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
  { url: `${BASE_URL}/vendeghaz/nyari-konyha`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
  { url: `${BASE_URL}/vendeghaz/etkezesi-ter`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.6 },
  { url: `${BASE_URL}/felpanzio`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
