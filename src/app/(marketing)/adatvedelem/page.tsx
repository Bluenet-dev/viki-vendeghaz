    ...
    <div className="pt-16 bg-stone min-h-screen">
      <section className="bg-ink py-16 px-6">
        <div className="mx-auto max-w-3xl">
          ...
          <h1 className="font-display text-4xl text-stone font-light">Adatvédelmi tájékoztató</h1>
        </div>
      </section>

      <section className="py-12 px-6">
        <div className="mx-auto max-w-3xl prose prose-bark">
          <div className="space-y-6 text-bark/75 leading-relaxed">
            <div>
              <h2 className="font-display text-2xl text-ink mb-2">Adatkezelő</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-ink mb-2">Kezelt adatok és céljuk</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-ink mb-2">Megőrzési idő</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-ink mb-2">Érintetti jogok</h2>
            ...
            <div>
              <h2 className="font-display text-2xl text-ink mb-2">Sütik (cookie-k)</h2>
            ...
            <p className="text-xs text-bark/40 border-t border-ink/8 pt-4 mt-8">
